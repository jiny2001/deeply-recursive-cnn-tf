...
flags.DEFINE_float("loss_alpha", 0, "Initial loss-alpha value. Don't use intermediate outputs when 0.")
flags.DEFINE_integer("loss_alpha_zero_epoch", 50, "Decrease loss-alpha to zero by this epoch")
flags.DEFINE_float("loss_beta", 0.0001, "Loss-beta for weight decay")
flags.DEFINE_float("weight_dev", 0.01, "Initial weight stddev")
flags.DEFINE_string("initializer", "momentum", "Initializer: can be [uniform, stddev, diagonal, xavier, he]")
